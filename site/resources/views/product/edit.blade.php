        ...
        <section class="card-style-shop">
            ...
            <form class="form" method='POST' action="{{ route('product.update', ['id' => $product->id]) }}"
                ...
                <input type="text" class="form_input @error('product_name') is-invalid @enderror"
                    placeholder="{{ $product->name }}" value="{{ $product->name }}" name="product_name">
                @error('product_name')
                ...
                <textarea spellcheck="true" class="form_input_textarea @error('product_description') is-invalid @enderror"
                    name="product_description" placeholder="{{ $product->description }}">{{ $product->description }}</textarea>
                ...
                <input type="number" class="form_input @error('product_price') is-invalid @enderror" name="product_price"
                ...
                <input type="text" class="form_input @error('product_tag') is-invalid @enderror" name="product_tag"
                    placeholder="{{ $product->tag }}" value="{{ $product->tag }}">
                @error('product_tag')
                    <label class="form_label_invalid">{{ $message }}</label>
                @enderror
