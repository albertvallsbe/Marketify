        ...
        <section class="card-style-shop">
            ...
            <form class="form" method='POST' action="{{ route('product.store') }}" enctype="multipart/form-data">
                ...
                <input type="text" class="form_input @error('product_name') is-invalid @enderror" placeholder="Premium Product X""
                    ...
                    <textarea class="form_input @error('product_description') is-invalid @enderror" name="product_description" placeholder="Experience superior quality and performance with ProX.">{{ old('product_description') }}</textarea>
