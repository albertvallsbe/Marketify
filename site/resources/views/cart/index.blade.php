    ...
    <section class="main-cart">
        ...
        <section class="card-style-account section summary">
            ...
            <div class="btns-cart">
                ...
                <button class="btn-buy general-button general-button_buy @if(count($products) == 0 || !auth()->user()) btn-disabled @endif " @if(count($products) == 0 || !auth()->user()) disabled @endif>GENERATE ORDER</button>
