        ...
        <section class="card-style-shop">
            ...
            @elsecan('customer')
                <form class="form" method="POST" action="{{ route('shop.create') }}" enctype="multipart/form-data">
                    ...
                    <input type="file" class="form_input input-mail @error('image') is-invalid @enderror" name="image"
                    ...
                    <input type="color" class="form_input_color @error('image') is-invalid @enderror" value="#84FF9B"
                        name="header_color" id="header_color">
                    @error('header_color')
                        <label class="form_label_invalid">{{ $message }}</label>
                    @enderror

                    <label class="form_label" for="background_color">Shop's background color:</label>
                    <input type="color" class="form_input_color @error('image') is-invalid @enderror" value="#D9FFE0"
