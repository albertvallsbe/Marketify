    ...
    <section class="main-login">
        <section class="card-style-login">
            ...
            <form class="form" method='POST'action="{{ route('auth.login') }}">
                ...
                <input type="text" class="form_input input-mail @error('current-password') is-invalid @enderror"
                    placeholder="Email/Username" name="login" value="{{ old('login') }}">

                <label class="form_label" for="current-password">Your password:</label>
                <input type="password" class="form_input input-password @error('current-password') is-invalid @enderror"
                    placeholder="••••••••••••" name="current-password">
        ...
        <section class="login-text intro-style-login">
            ...
            <p class="intro-style-login_text">Marketify is an application that allows you to buy products and sell them at
                the same
