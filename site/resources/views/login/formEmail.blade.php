...
@section('content')
    <section class="main-password">
        <section class="card-style-password section-content">
            ...
            <p class="card-style-password_content">Have you forgotten the password? Don't worry. Enter your email and we will
                send you an email to recover your password.
        ...
        <section class="login-text intro-style-password">
            ...
            <p class="intro-style-password_text">This is an application that allows you to buy products and sell them at the
                same
