...
sudo composer create-project --prefer-dist laravel/laravel /home/marketify/ApiMarketplace

# Configurar Apache para Laravel
# sudo tee /etc/apache2/sites-available/000-default.conf > /dev/null <<EOF
# <VirtualHost *:80>
#     ServerAdmin webmaster@localhost
#     DocumentRoot /home/marketify/ApiMarketplace/public

#     <Directory /home/marketify/ApiMarketplace/public>
...
sudo chown -R www-data:www-data /home/marketify/ApiMarketplace

# Establecer permisos adicionales en los directorios de Laravel
sudo chmod -R 775 /home/marketify/ApiMarketplace/storage
sudo chmod -R 775 /home/marketify/ApiMarketplace/bootstrap/cache
sudo chmod -R 775 /home/marketify/ApiMarketplace/public
...
sudo sed -i 's#DocumentRoot /var/www/html#DocumentRoot /home/marketify/ApiMarketplace/public#' /etc/apache2/sites-available/default-ssl.conf

# Modificar la configuración de puertos para escuchar el puerto 8080
...
# Configurar el archivo 000-default.conf con el VirtualHost para el puerto 8080 y 443, además de forzar la redirección a HTTPS
sudo tee /etc/apache2/sites-available/000-default.conf > /dev/null <<EOF
<VirtualHost *:8080>
    ServerAdmin webmaster@localhost
    DocumentRoot /home/marketify/ApiMarketplace/public
...
<VirtualHost *:443>
    ...
    # Especificar la versión de SSL para cURL
